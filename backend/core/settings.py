...
CORS_ALLOWED_ORIGINS = config("CORS_ALLOWED_ORIGINS", default="http://localhost:5173", cast=csv_list)
CORS_TRUSTED_ORIGINS = config("CORS_TRUSTED_ORIGINS", default="http://localhost:5173", cast=csv_list)
