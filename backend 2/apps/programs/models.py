...
class Program(ApexModel):
    ...
    def save(self, *args, **kwargs):
        if (
            not self.trainer_client_membership
            or not self.trainer_client_membership.is_active
        ):
            raise ValidationError("Cannot create a program on an inactive membership")
