...
REST_AUTH = {
    ...
    "JWT_SERIALIZER_WITH_EXPIRATION": "dj_rest_auth.serializers\
        .JWTSerializerWithExpiration",
    "JWT_TOKEN_CLAIMS_SERIALIZER": "rest_framework_simplejwt.serializers\
        .TokenObtainPairSerializer",
    "USER_DETAILS_SERIALIZER": "apps.users.serializers.CustomUserSerializer",
    "PASSWORD_RESET_SERIALIZER": "dj_rest_auth.serializers.PasswordResetSerializer",
    "PASSWORD_RESET_CONFIRM_SERIALIZER": "dj_rest_auth.serializers\
